...
//            $mobile = $this->request->post('mobile', '');
            ...
            $invite_code = $this->request->post('inviteCode');
...
//                'mobile'    => $mobile,
            ...
            //验证码
            $captchaResult = true;
            if (ConfigurationHandle::getSystemConfigMailSwitch()) {
            ...
            if ($this->auth->register($email, $password, $invite_code, $email, '', ['nickname' => $nickname])) {
...
//                '__token__'     => $token,
            ...
            $ret = $this->auth->changepwd($newpassword, $oldpassword, false, false);
            if ($ret) {
