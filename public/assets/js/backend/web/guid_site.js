define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'web/guid_site/index' + location.search,
                    add_url: 'web/guid_site/add',
                    edit_url: 'web/guid_site/edit',
                    del_url: 'web/guid_site/del',
                    multi_url: 'web/guid_site/multi',
                    import_url: 'web/guid_site/import',
                    table: 'web_guid_site',
                }
            });
